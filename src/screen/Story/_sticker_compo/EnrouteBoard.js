...
export class DraggableEvent extends Component {
  ...
  onLongPressEvent = () =>{
    ...
    this.props.deleteStickers(!isOnLongPressed,4)
            ...
            <TouchableOpacity      
             ...
             >
              <Animated.Image
                ...
                source={require("../../../assets/stickers/new/enroute-sticker-2.png")}
                resizeMode={'contain'}
              />
              </TouchableOpacity>
            </Animated.View>
...
export default class EnrouteBoard extends Component {
  render() {
