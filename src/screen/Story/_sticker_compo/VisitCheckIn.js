...
export class DraggableEvent extends Component {
  ...
  onLongPressEvent = () =>{
    ...
    this.props.deleteStickers(!isOnLongPressed,1)
            ...
            <TouchableOpacity      
              ...
              >
                  <Image style={{ width: 30, height: 30,marginRight:5,
                    top : -20,position:'absolute',marginLeft:0 }} 
                    source={require('../../../assets/Images/new/story_location.png')}
                    resizeMode={'contain'}
                   />
                  <Text style={{fontSize:20,color:'#222222',textAlign:'center'
...
export default class VisitCheckIn extends Component {
  render() {
    const {isActive,location,multiImage,SMI,sIndex,sticId,EmitterRoutes,
      points,deleteStickers} = this.props
    return (
