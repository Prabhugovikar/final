...
export class DraggableEvent extends Component {
  ...
  onLongPressEvent = () =>{
    ...
    this.props.deleteStickers(!isOnLongPressed,15)
...
export default class CurrentDay extends Component {
  render() {
    const {isActive,multiImage, SMI,sIndex,sticId,EmitterRoutes,points,children,deleteStickers} = this.props;
    return (
      <View style={styles.mainView}>
       {isActive && (
         <DraggableEvent children={children} 
