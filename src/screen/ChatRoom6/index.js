...
class ChatRoom extends Component {
    ...
    async componentDidMount() {
        ...
        const storedTheme = await AsyncStorage.getItem('theme7');
        if (storedTheme) {
            this.setState({
                theme: storedTheme
            });
   ...
   Finger_print() {
    ...
    setTheme() {
        ...
        fetch(API_URL + "setthemegroup", requestOptions)
            ...
            .then(result => {
                ...
                AsyncStorage.setItem('theme7', result.result.setTheme);
            })
            .catch(error => console.log('error', error));
    }
    ...
    render() {
        const { Activated, ProfileName, isVisible, modalVisible, names, selectedMessageIds, theme } = this.state;
                                        ...
                                        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                                            ...
                                            <TouchableOpacity onPress={this.pickDocument} style={styles.options}>
                                                <View style={styles.options1}>
                                                    <Icon name="file" size={25} color='darkblue' />
                                                </View>
