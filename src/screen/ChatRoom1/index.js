...
class ChatRoom extends Component {
    ...
    async componentDidMount() {
        ...
        const storedTheme = await AsyncStorage.getItem('theme2');
        if (storedTheme) {
            this.setState({
                theme: storedTheme
            });
    ...
    setTheme() {
        ...
        fetch(API_URL + "setthemegroup", requestOptions)
            ...
            .then(result => {
                ...
                AsyncStorage.setItem('theme2', result.result.setTheme);
            })
            .catch(error => console.log('error', error));
    }
    ...
    render() {
        const { Activated, ProfileName, isVisible, names, selectedMessageIds, theme, isOpen } = this.state;
